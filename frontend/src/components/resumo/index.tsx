	...
	return (
		<section className="relative py-10 px-4 sm:px-6 overflow-hidden">
			<div className="relative z-10 max-w-[1200px] mx-auto">
				<div 
					className="bg-[#0f0f12]/80 backdrop-blur-md border border-white/[0.04] rounded-[32px] overflow-hidden px-8 py-16 sm:px-12 sm:py-16 shadow-2xl flex flex-col items-center text-center"
				>
					<div data-aos="fade-up" className="max-w-[760px] flex flex-col items-center space-y-10">
						...
						<div className="space-y-5">
							...
							<h2 className={`${fontSatoshi.className} text-zinc-100 text-2xl sm:text-[2.65rem] font-semibold leading-tight tracking-tight`}>
								I am a passionate software developer looking for opportunity.
							</h2>
						</div>

						<div className={`${fontSatoshi.className} space-y-5 text-zinc-400 text-base sm:text-lg leading-[1.55] max-w-2xl font-light`}>
							<p>
